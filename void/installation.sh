...
AUDIO='pipewire alsa-pipewire wireplumber alsa-utils pulsemixer gstreamer1 gstreamer1-devel gstreamer1-pipewire gstreamer1-32bit gstreamer1-devel-32bit gstreamer1-pipewire-32bit gstreamer-vaapi gst-plugins-bad1 gst-plugins-base1 gst-plugins-base1-32bit gst-plugins-good1 gst-plugins-ugly1 gst-libav'
WM_XORG='bspwm sxhkd dunst polybar kitty python3-dbus rofi'
