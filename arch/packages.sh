...
FONTS="inter-font noto-fonts-emoji ttf-fira-code nerd-fonts-fira-code"
XORG="xorg-server xorg-xinit xorg-xrandr xclip feh"
WM="sxhkd-git bspwm-git polybar picom-animations-git xfce-polkit dunst-git rofi"
...
LANGUAGES="nodejs-lts-gallium npm yarn lua fennel"
TERMINAL_CLIENTS="tuir"

$PKG_MANAGER -Sy --needed $TOOLS $KERNEL $FONTS $XORG $WM $AUDIO $SHELL $VIDEO_DRIVERS $LANGUAGES $TERMINAL_CLIENTS
