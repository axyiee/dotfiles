...
WM_XORG="bspwm sxhkd kitty feh picom-animations-git"
...
TOOLS="zsh git git-delta fzy wget lxappearance exa opendoas unzip neovim nvim-packer-git neofetch maim xclip zoxide pamixer tmux dbus dbus-runit"
