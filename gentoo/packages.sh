...
(mkdir -p ~/.themes && cd ~/.themes && wget https://github.com/catppuccin/gtk/releases/download/update_23_02_2022/Catppuccin-purple.zip && unzip Catppuccin-purple.zip && rm -f Catppuccin-purple.zip)
